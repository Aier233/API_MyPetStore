...
class MyPetStoreApiApplicationTests {
    ...
    @Test
    void addItem(){
        CommonResponse<ItemVO> itemById = catalogService.getItemById("EST-6");
        System.out.println(itemById.getData());
        cartService.addItem("123",itemById.getData().getListPrice(),"Test");
    }
